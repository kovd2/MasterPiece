...
/**
 * Servlet implementation class LowPriceListServlet
 */
@WebServlet("/lowPrice")
public class LowPriceListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LowPriceListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("category : " + category);
			...
			ArrayList<Product> prdList = new ProductService().lowList(currentPage, limit, category);
