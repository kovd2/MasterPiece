...
/**
 * Servlet implementation class HighPriceListServlet
 */
@WebServlet("/highPrice")
public class HighPriceListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HighPriceListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("category : " + category);
			...
			ArrayList<Product> prdList = new ProductService().highList(currentPage, limit, category);
