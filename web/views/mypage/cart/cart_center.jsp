		...
		<div class="center_top_content">
			<div class="wrap">
				...
				<div class="cart_title">
					<table>
						<tr>
							<td style="width: 39px; height: 31px;"><input
								type="checkbox"></td>
					...
					<div class="cart_list">
						<table>
							<tr>
								<td style="width: 39px; height: 31px;"><input
									type="checkbox"></td>
								<td><img src="../../images/cart_product1.jpg"
									style="width: 100px; height: 85px;"></td>
								<td style="width: 400px; height: 31px;">[AMD] 라이젠 3 레이븐릿지
									2200G (쿼드코어/3.5GHz/쿨러포함/대리점정품) Ryean 3 2200G(3.5GHz) /
									쿼드코어(4코어) / 라이젠 / 소켓AM4 / 6MB버퍼 / 14nm / AMD 라데온 Vega 8 내장그래픽</td>
								<td style="width: 120px; height: 31px;">가격 : 217000원</td>
								<td style="width: 120px; height: 31px;"><select>
										<option>----</option>
										<option>1</option>
										<option>2</option>
										<option>3</option>
					...
					<div class="price_area">
						<div class="priceArea">
							...
							<div class="service_btn">
								<span id="service_price">20,000원</span>
								<button>신청</button>
							</div>
							<div class="service_btn2">
								<span id="service_price">15,000원</span>
								<button>신청</button>
							</div>
							<div class="service_btn2">
								<span id="service_price">2,000원</span>
								<button>신청</button>
							</div>
							<div class="service_btn2">
								<span id="service_price">9,900원</span>
								<button>신청</button>
							</div>
						</div>

						<img alt="" src="../../images/cart_1.png"
							style="width: 1050px; height: 230px;">


						<div class="go_shopping" onclick="goList()">
							<img src="../../images/button_1.gif">
						</div>
						<div class="purchase" onclick="goBuy()">
							<img src="../../images/button_2.gif">
						</div>
					</div>
					<br>
					<br>
         ...
         function goBuy(){
			...
			<!-- 			<div id="no_cart_item" class="div_all_layer">장바구니에 상품이 존재하지
				않습니다.</div>

			<div class="div_all_layer"
				style="font-size: 12px; text-align: center; margin-bottom: 10px">
				<span style="color: #f02857;">특정상품의 경우 (30인치 이상
					모니터,업체배송제품,파손위험제품, 고가품, 부피가 큰제품) 택배사가 변경되어 발송될수 있습니다.</span>
			</div> -->
