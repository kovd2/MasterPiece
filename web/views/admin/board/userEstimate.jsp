			...
			<div class="inb" id="board" style="width:600px;">
				...
				<div>
					<div>
						...
						<span style="padding-left:10px; font-weight:bold; font-size:large; float:left; width:290px;">유저 견적 게시판</span>
						<br clear="both">
						<form>
				...
				<br>
				<div>
					<button type="button" class="btn btn-danger" style="padding:2px 4px; float:right;" onclick="location.href='userEstimateWrite.jsp'">글쓰기</button>
				</div>
			</div>
		</div>
		<br clear="both">
