...
<%@ include file="../common/top.jsp"%>
	...
	IMP.request_pay({
	    ...
	    if ( rsp.success ) {
	    	...
	    	jQuery.ajax({
	    		url: '/MasterPiece/payMent', //cross-domain error가 발생하지 않도록 동일한 도메인으로 전송
	    		type: 'POST',
	    		dataType: 'json',
	    		data: {
		    		id : <%=id%>,
	    	...
	    	<%-- .done(function(data) {
	    		...
	    		if ( everythings_fine ) {
	    			...
	    			location.href="<%=request.getContextPath()%>/payMent?id=id + "&price=" + price + "&select=" + select + "&applyno=" + applyno";
	    		} else {
